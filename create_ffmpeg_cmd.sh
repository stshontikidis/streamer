...
FFMPEG_CMD="ffmpeg -rtsp_transport tcp -i rtsp://192.168.1.5:7447/5e8e5257e4b088237a8892cc_1 -codec:a ${DEFAULT_AUDIO} -vn -hls_list_size 2 -hls_init_time 1 -hls_time 1 -hls_flags delete_segments  ${OUTPUT_PATH}${OUTPUT}.m3u8"
